...
// канал чтения из сокета
            ...
            while (!clientDialog.isClosed()) {
                ...
                int number = readNumberFromFile("./src/data.txt");

                System.out.println("Server try writing to channel");
                System.out.println("Server try writing to channel number " + number);
                out.writeUTF("Server reply - number is: " + number);
    ...
    private int readNumberFromFile(String filePath) {
        int number = 0;
